...
{
    public sealed class CoordinatesCrossoverExtendedLine<TAlgorithm, TProblem, TSolution>
        ...
        where TSolution : class, IPoint<TSolution>
    {
        ...
        public CoordinatesCrossoverExtendedLine()
        {
            GetDimension = null;
            GetRandom = null;
        }
        ...
        public override void CrossCoordinates(TSolution[][] parents, TSolution[] children)
        {
            ...
            for (int c = 0; c < children.Length; c++)
            {
                ...
                double factor = 1.5 * random.NextDouble() - 0.25;
